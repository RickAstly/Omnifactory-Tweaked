...
* Added several (Advanced Rocketry) planets. These planets also have a few exclusive ores, for more details see [GuideToThePlanets.md](overrides/guides/GuideToThePlanets.md).
...
* Added dogecoin
For the rest of the changes, see [Tweaks.md](overrides/guides/Tweaks.md)
